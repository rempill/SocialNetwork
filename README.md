...
This template contains an empty [Gradle](https://gradle.org/) project, in which you will be asked to implement the requirements for the Social Network project.
